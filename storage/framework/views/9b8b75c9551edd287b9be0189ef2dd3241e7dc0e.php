                    ...
                    <div class="col-lg-6 margin-bottom-20" style="margin: 0 auto;">
                        <form method="POST" action="<?php echo e(route('users.store')); ?>" role="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="Dni" name="Dni" maxlength="250" class="form-control<?php echo e($errors->has('Dni') ? ' is-invalid' : ''); ?>" placeholder="DNI" value="<?php echo e(old('Dni')); ?>">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input id="email" name="email" maxlength="250" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" placeholder="Email" value="<?php echo e(old('email')); ?>">
...
<script>
    ...
    function setUserFields(type) {
        ...
        if (type == 1) {
            $('#group_id_box').hide();
            $('#color_initials_box').hide();
            $('#group_id').val("");
            $('#color').val("");
            $('#initials').val("");       
        } else {
            $('#group_id_box').show();
            $('#color_initials_box').show();
        }
    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Biblioteca/resources/views/admin/user/create.blade.php ENDPATH**/ ?>